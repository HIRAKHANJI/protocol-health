...
**Current version:** `protocol-health-v18`
...
```javascript
// sw.js — line 22
const CACHE_NAME = 'protocol-health-v18'; // ← increment this on every significant push
```
...
```javascript
const APP_VERSION = '5.5.0';                         // ← bump according to rules above
...
Cache:        sw.js CACHE_NAME = "protocol-health-v18" — bump on every significant push
App version:  APP_VERSION = "5.5.0" — bump on notable updates (see Section 12)
