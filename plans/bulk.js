export const bulk = {
  ...
  // m3 (breakfast) and e2 (rest-day walk) are normal manual ticks — NOT workout-driven.
  ...
  lightDayCalorieFactor: 1.0,  // light days = maintenance/TDEE for gut recovery (plan copy: "eat at or slightly below TDEE")
